            ...
            {all_students.map((student, index) => (
              <View key={index} style={styles.studentChartContainer}>
                ...
                <View style={{ flex: 1, flexDirection: 'row' }}>
                  ...
                  <TouchableOpacity
                    style={
                      this.state.leavePressedList.includes(index)
                        ? [styles.leavetButton, { backgroundColor: 'yellow' }]
                        : styles.leaveButton
                    }
                    onPress={() => {
                      var leavePressedList = this.state.leavePressedList;
                      leavePressedList.push(index);
                      this.setState({ leavePressedList: leavePressedList });
                      var roll_no = index + 1;
                      this.updateAttendence(roll_no, 'leave');
                    }}>
                    <Text>Leave</Text>
                  </TouchableOpacity>
